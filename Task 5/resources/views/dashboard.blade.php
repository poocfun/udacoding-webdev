            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <span> <h4>Table Leaderboard</h4></span>
                        <a  style="margin-left: 840px;" href="#" class="btn btn-primary"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Data</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger"href="{{url('delete-leaderboard/'.$row->id)}}"><i class="fa fa-trash"></i>Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('leaderboard') }}" method="post">
            @csrf
            <label for="">Nama Peserts</label>
